...
EMBEDDINGS_FILE = './data/all_chunks_embeddings.pt'
SOURCE_MAP_FILE = './data/embedding_source_map.json'
CHUNKS_DIR = './data/' # Directory where your chunk JSON files are
CHROMA_DB_PATH = "./chroma_db" # Path for the Chroma DB data
